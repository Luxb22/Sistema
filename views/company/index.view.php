...
<body>
	...
	<div class="hero overlay">
		<img src="assets/landing/images/blob.svg" alt="" class="img-fluid blob">
		<div class="container">
...
<div class="section sec-cta overlay" style="background-image: url('assets/landing/images/img-3.jpg')">
	<div class="container">
		...
		<div id="post-slider" class="post-slider">
			<div class="item">
				<a href="case-study.html" class="card d-block">
					<img src="assets/landing/images/img-1.jpg" class="card-img-top" alt="Image">
					<div class="card-body">
			...
			<div class="item">
				<a href="case-study.html" class="card">
					<img src="assets/landing/images/img-2.jpg" class="card-img-top" alt="Image">
					<div class="card-body">
						<h5 class="card-title">Behind the word mountains</h5>
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
					</div>
			...
			<div class="item">
				<a href="case-study.html" class="card">
					<img src="assets/landing/images/img-3.jpg" class="card-img-top" alt="Image">
					<div class="card-body">
						<h5 class="card-title">Behind the word mountains</h5>
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
					</div>
			...
			<div class="item">
				<a href="case-study.html" class="card">
					<img src="assets/landing/images/img-4.jpg" class="card-img-top" alt="Image">
					<div class="card-body">
						<h5 class="card-title">Behind the word mountains</h5>
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
					</div>
			...
			<div class="testimonial-slider" id="testimonial-slider">
				<div class="item">
					<div class="testimonial-half d-lg-flex bg-white">
						<div class="img" style="background-image: url('assets/landing/images/img-4.jpg')">
				...
				<div class="item">
					<div class="testimonial-half d-lg-flex bg-white">
						<div class="img" style="background-image: url('assets/landing/images/img-3.jpg')">
				...
				<div class="item">
					<div class="testimonial-half d-lg-flex bg-white">
						<div class="img" style="background-image: url('assets/landing/images/img-2.jpg')">
		...
		<div class="row">
			<div class="col-lg-4">
				<div class="card post-entry">
					<a href="single.html"><img src="assets/landing/images/img-1.jpg" class="card-img-top" alt="Image"></a>
					<div class="card-body">
			...
			<div class="col-lg-4">
				<div class="card post-entry">
					<a href="single.html"><img src="assets/landing/images/img-2.jpg" class="card-img-top" alt="Image"></a>
					<div class="card-body">
						<div><span class="text-uppercase font-weight-bold date">Jan 20, 2021</span></div>
						<h5 class="card-title"><a href="single.html">Behind the word mountains</a></h5>
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
			...
			<div class="col-lg-4">
				<div class="card post-entry">
					<a href="single.html"><img src="assets/landing/images/img-3.jpg" class="card-img-top" alt="Image"></a>
					<div class="card-body">
						<div><span class="text-uppercase font-weight-bold date">Jan 20, 2021</span></div>
						<h5 class="card-title"><a href="single.html">Behind the word mountains</a></h5>
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
