...
<html lang="en">
    ...
    <head>
        ...
        <!-- Timeline CSS -->
        <link href="assets/dashboard/css/timeline.css" rel="stylesheet">

        <!-- Custom CSS -->
        <link href="assets/dashboard/css/startmin.css" rel="stylesheet">

        <!-- Morris Charts CSS -->
        <link href="assets/dashboard/css/morris.css" rel="stylesheet">

        <!-- Custom Fonts -->
        <link href="assets/dashboard/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">MITRA</a>
                </div>
        ...
        <script src="assets/dashboard/js/morris-data.js"></script>

        <!-- Custom Theme JavaScript -->
        <script src="assets/dashboard/js/startmin.js"></script>
